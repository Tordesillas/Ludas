...
export function isTileOutOfBound(tileId: number): boolean {
    return (tileId < 0) || (106 < tileId && tileId < 200) || (206 < tileId && tileId < 300)
        || (306 < tileId && tileId < 400) || (406 < tileId);
}
...
const BOARD_TILES: Tile[] = [...TOP_ARM_TILES, ...BOTTOM_ARM_TILES, ...LEFT_ARM_TILES, ...RIGHT_ARM_TILES, ...END_TILES]
...
const YARD_TILES: Tile[] = [...ORANGE_YARD_TILES, ...PURPLE_YARD_TILES, ...GREEN_YARD_TILES, ...BLUE_YARD_TILES]
    .sort((t1, t2) => t1.id - t2.id);